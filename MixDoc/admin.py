...
class osAdmin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('os_title', 'os_discription','os_download',)
...
class os1Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('os_title1', 'os_discription1','os_download1',)
...
class os2Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('os_title2', 'os_discription2','os_download2',)
...
class ResumeModelAdmin(admin.ModelAdmin):
    ...
    'city', 'pin', 'state', 'mobile', 'job_city', 'skills', 'projects',
    'intro', 'qulification', 'clg_name', 'percentage', 'profile_image','my_file']
    list_per_page = 4
    list_filter = ('name',)
    search_fields = ('name',)
    list_editable = ('name','locality','city','mobile','job_city','skills','projects','intro','profile_image',)
    
    
class newscardAdmin(admin.ModelAdmin):
    list_display = ("id", "newsname", "newspic", "newslink")
    list_per_page = 4
    list_editable = ('newsname', 'newslink',)
...
class newscard1Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('newsname1', 'newslink1',)
...
class newscard2Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('newsname2', 'newslink2',)
...
class newscard3Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('newsname3', 'newslink3',)
...
class newscard4Admin(admin.ModelAdmin):
    ...
    list_per_page = 4
    list_editable = ('newsname4', 'newslink4',)
...
class templateResumeAdmin(admin.ModelAdmin):
    ...
    list_editable = ('temp_pic','temp_download',)
